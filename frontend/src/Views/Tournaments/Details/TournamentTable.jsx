export default function TournamentTable({ participants = [] }) {
  if (participants.length === 0) {
    return (
      <table className="w-[100%] text-[var(--background-yellow)] border-collapse mx-auto">
        <thead>
          <tr>
            <th
              colSpan={3}
    ...
    <table className="w-[100%] text-[var(--background-yellow)] border-collapse mx-auto">
      <thead>
        <tr className="">
          ...
          <th className="uppercase text-2xl py-2 px-4 text-center">Elo</th>
          <th className="uppercase text-2xl py-2 px-4 text-center">Puntos</th>
        </tr>
      </thead>
      <tbody>
