...
export default function DocumentTemplatesTable({
  ...
  hasDownloadAuditDocumentTemplate = (item) => false,
  buttonAddRoute,
  buttonShowRoute,
  buttonEditRoute,
  buttonDeleteRoute,
  buttonApproveRoute,
  buttonDownloadAuditDocumentTemplateRoute,
  confirmModalText,
}) {
          ...
          <thead>
            <tr className="box-theme">
              ...
              {(hasShow ||
                ...
                hasDelete ||
                hasApprove ||
                hasDownloadAuditDocumentTemplate) && (
                        ...
                        <>
                          {hasShow(item) && (
                            <Link
                              ...
                              title="Ver plantilla de auditoria"
                            >
                              <FaFile className="text-lg" size={24} />
                            </Link>
                          )}
                          {hasEdit(item) && (
                            <Link
                          ...
                          {hasDownloadAuditDocumentTemplate(item) && (
                            <button
                              title="Descargar PDF"
                              onClick={() =>
                                buttonDownloadAuditDocumentTemplateRoute(
                              ...
                              className="text-green-700 hover:text-green-600 hover"
                            >
                    ...
                    <>
                      ...
                      {hasDownloadAuditDocumentTemplate(item) && (
                        <button
                          title="Descargar PDF"
                          onClick={() =>
                            buttonDownloadAuditDocumentTemplateRoute(item.id)
                          }
                          className="text-green-700 hover:text-green-600 hover"
                        >
                          <FiDownload className="text-lg" size={24} />
