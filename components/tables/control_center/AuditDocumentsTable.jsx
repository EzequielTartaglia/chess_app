...
export default function AuditDocumentsTable({
  ...
  hasDownloadAuditDocument = (item) => false,
  buttonAddRoute,
  buttonShowRoute,
  buttonEditRoute,
  buttonDeleteRoute,
  buttonApproveRoute,
  buttonDownloadAuditDocumentRoute,
  confirmModalText,
  customButton,
}) {
                    ...
                    <div className="flex items-center mt-4">
                      {(hasShow ||
                        ...
                        <>
                          ...
                          {hasDownloadAuditDocument(item) && (
                            <button
                              title="Descargar PDF"
                              onClick={() =>
                                buttonDownloadAuditDocumentRoute(item.id)
                              }
                              className="text-green-700 hover:text-green-600 hover mr-4"
                            >
